...
public partial class BentukDasar : RefCounted, IDisposable
{
  ...
  public List<Vector2> Lingkaran(Vector2 titikTengah, int radius)
  {
    return CheckPrimitifAndCall(() => _primitif.CircleMidPoint((int)titikTengah.X, (int)titikTengah.Y, radius));
  }

  public List<Vector2> Elips(Vector2 titikTengah, int radiusX, int radiusY)
  {
    return CheckPrimitifAndCall(() => _primitif.EllipseMidpoint((int)titikTengah.X, (int)titikTengah.Y, radiusX, radiusY));
  }
