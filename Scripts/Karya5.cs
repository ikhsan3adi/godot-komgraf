...
public partial class Karya5 : Node2D
{
  ...
  {
    // Trapesium Siku-siku
    Vector2 titikAwalTrapesium3 = ScreenUtils.ConvertToPixel(-220, -220, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
    ...
    // Trapesium Sama Kaki
    Vector2 titikAwalTrapesiumSamaKaki3 = ScreenUtils.ConvertToPixel(-340, -220, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
  ...
  private void MyLingkaran()
  {
    ...
    Vector2 titikTengah = ScreenUtils.ConvertToPixel(150, -150, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
  ...
  {
    // kartesian to screen/pixel
    Vector2 titikTengah = ScreenUtils.ConvertToPixel(350, -150, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
