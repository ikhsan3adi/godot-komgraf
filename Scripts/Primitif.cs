...
public partial class Primitif : RefCounted
{
  ...
  public List<Vector2> PersegiPanjang(float x, float y, float panjang, float lebar)
  {
    ...
    res.AddRange(LineBresenham(x + panjang, y + 1, x + panjang, y + lebar));
    res.AddRange(LineBresenham(x + panjang - 1, y + lebar, x, y + lebar));
  ...
  public List<Vector2> SegitigaSiku(Vector2 titikAwal, int alas, int tinggi)
  {
    ...
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y + 1, titikAwal.X, titikAwal.Y - tinggi)); // Tinggi
    res.AddRange(LineBresenham(titikAwal.X + alas, titikAwal.Y, titikAwal.X, titikAwal.Y - tinggi)); // Miring
    return res;
  }
  ...
  public List<Vector2> SegitigaSamaKaki(Vector2 titikAwal, int alas, int tinggi)
  {
    List<Vector2> res = new List<Vector2>();
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + alas, titikAwal.Y)); // Alas
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y + 1, titikAwal.X + alas / 2, titikAwal.Y - tinggi)); // Sisi kiri
    res.AddRange(LineBresenham(titikAwal.X + alas, titikAwal.Y, titikAwal.X + alas / 2, titikAwal.Y - tinggi)); // Sisi kanan
    return res;
  }
  ...
  {
    List<Vector2> res = new List<Vector2>();
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + panjangBawah, titikAwal.Y)); // Alas bawah
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y - tinggi, titikAwal.X + panjangAtas, titikAwal.Y - tinggi)); // Sisi atas
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X, titikAwal.Y - tinggi)); // Sisi kiri
    res.AddRange(LineBresenham(titikAwal.X + panjangBawah, titikAwal.Y, titikAwal.X + panjangAtas, titikAwal.Y - tinggi)); // Sisi miring kanan
    return res;
  }
  ...
  public List<Vector2> TrapesiumSamaKaki(Vector2 titikAwal, int panjangAtas, int panjangBawah, int tinggi)
  {
    List<Vector2> res = new List<Vector2>();
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + panjangBawah, titikAwal.Y)); // Alas bawah
    res.AddRange(LineBresenham(titikAwal.X + (panjangBawah - panjangAtas) / 2, titikAwal.Y - tinggi, titikAwal.X + (panjangBawah + panjangAtas) / 2, titikAwal.Y - tinggi)); // Sisi atas
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + (panjangBawah - panjangAtas) / 2, titikAwal.Y - tinggi)); // Sisi kiri
    res.AddRange(LineBresenham(titikAwal.X + panjangBawah, titikAwal.Y, titikAwal.X + (panjangBawah + panjangAtas) / 2, titikAwal.Y - tinggi)); // Sisi kanan
    return res;
  }
  ...
  {
    List<Vector2> res = new List<Vector2>();
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + alas, titikAwal.Y)); // Alas bawah
    res.AddRange(LineBresenham(titikAwal.X + jarakBeda, titikAwal.Y - tinggi, titikAwal.X + alas + jarakBeda, titikAwal.Y - tinggi)); // Alas atas
    res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + jarakBeda, titikAwal.Y - tinggi)); // Sisi kiri
    res.AddRange(LineBresenham(titikAwal.X + alas, titikAwal.Y, titikAwal.X + alas + jarakBeda, titikAwal.Y - tinggi)); // Sisi kanan
    return res;
  }
