...
public partial class Karya3 : Node2D
{
  ...
  private void MyGaris()
  {
    ...
    Vector2 titikAwal1 = ScreenUtils.ConvertToPixel(20, 200, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
    ...
    Vector2 titikAwal2 = ScreenUtils.ConvertToPixel(300, 200, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
    ...
    Vector2 titikAwal3 = ScreenUtils.ConvertToPixel(20, 50, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
    ...
    Vector2 titikAwal4 = ScreenUtils.ConvertToPixel(300, 50, ScreenUtils.MarginLeft, ScreenUtils.MarginTop);
