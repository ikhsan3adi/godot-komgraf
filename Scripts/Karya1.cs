...
public partial class Karya1 : Node2D
{
	...
	[Export]
	private CheckButton _translateToggleCheckBtn;

	[Export]
	private CheckButton _rotateToggleCheckBtn;

	[Export]
	private CheckButton _scaleToggleCheckBtn;
	...
	public override void _Ready()
	{
		...
		_translateToggleCheckBtn.ButtonPressed = translateEnabled;
		_rotateToggleCheckBtn.ButtonPressed = rotateEnabled;
		_scaleToggleCheckBtn.ButtonPressed = scaleEnabled;
	...
	public void _on_translate_button_toggled(bool enabled)
	{
		translateEnabled = enabled;
		QueueRedraw();
	}
	public void _on_rotate_button_toggled(bool enabled)
	{
		rotateEnabled = enabled;
		QueueRedraw();
	}
	public void _on_scale_button_toggled(bool enabled)
	{
