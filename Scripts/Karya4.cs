...
public partial class Karya4 : Node2D
{
  ...
  private void MyPersegi()
  {
    // Persegi
    // Kuadran 1 
    Vector2 titikAwalPersegi1 = ScreenUtils.ConvertToPixel(100, 100);
    ...
    // Kuadran 3 
    Vector2 titikAwalPersegi3 = ScreenUtils.ConvertToPixel(-150, -150);
    ...
    // Kuadran 4 
    Vector2 titikAwalPersegi4 = ScreenUtils.ConvertToPixel(100, -150);
    ...
    // Persegi Panjang
    // Kuadran 1 
    Vector2 titikAwalPersegiPanjang1 = ScreenUtils.ConvertToPixel(200, 150);
    ...
    // Kuadran 3 
    Vector2 titikAwalPersegiPanjang3 = ScreenUtils.ConvertToPixel(-270, -190);
    ...
    // Kuadran 4 
    Vector2 titikAwalPersegiPanjang4 = ScreenUtils.ConvertToPixel(200, -190);
  ...
  private void MySegitiga()
  {
    ...
    // Kuadran 2 
    Vector2 titikAwalSegitiga2 = ScreenUtils.ConvertToPixel(-90, 30);
    ...
    // Kuadran 3 
    Vector2 titikAwalSegitiga3 = ScreenUtils.ConvertToPixel(-90, -80);
    ...
    // Kuadran 4 
    Vector2 titikAwalSegitiga4 = ScreenUtils.ConvertToPixel(30, -80);
    ...
    Vector2 titikAwalSegitigaSamaKaki2 = ScreenUtils.ConvertToPixel(-370, 50);
    ...
    Vector2 titikAwalSegitigaSamaKaki3 = ScreenUtils.ConvertToPixel(-370, -110);
    ...
    Vector2 titikAwalSegitigaSamaKaki4 = ScreenUtils.ConvertToPixel(300, -110);
  ...
  private void MyTrapesium()
  {
    // Trapesium Siku-siku
    // Kuadran 1 
    Vector2 titikAwalTrapesium1 = ScreenUtils.ConvertToPixel(150, 200);
    ...
    // Kuadran 2 
    Vector2 titikAwalTrapesium2 = ScreenUtils.ConvertToPixel(-220, 200);
    ...
    // Kuadran 3 
    Vector2 titikAwalTrapesium3 = ScreenUtils.ConvertToPixel(-220, -290);
    ...
    // Kuadran 4 
    Vector2 titikAwalTrapesium4 = ScreenUtils.ConvertToPixel(150, -290);
    ...
    // Trapesium Sama Kaki
    // Kuadran 1 
    Vector2 titikAwalTrapesiumSamaKaki1 = ScreenUtils.ConvertToPixel(280, 200);
    ...
    // Kuadran 2 
    Vector2 titikAwalTrapesiumSamaKaki2 = ScreenUtils.ConvertToPixel(-340, 200);
    ...
    // Kuadran 3 
    Vector2 titikAwalTrapesiumSamaKaki3 = ScreenUtils.ConvertToPixel(-340, -265);
    ...
    // Kuadran 4 
    Vector2 titikAwalTrapesiumSamaKaki4 = ScreenUtils.ConvertToPixel(280, -265);
